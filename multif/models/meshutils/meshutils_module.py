...
def py_WriteMesh2(OutNam, pyVer, pyTri, pyTet, pyEdg, pySol):
    return _meshutils_module.py_WriteMesh2(OutNam, pyVer, pyTri, pyTet, pyEdg, pySol)
py_WriteMesh2 = _meshutils_module.py_WriteMesh2
